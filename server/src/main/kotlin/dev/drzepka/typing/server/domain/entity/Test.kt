...
open class Test(
    ...
    init {
       if (selectedWords == null != !testDefinition.canGenerateWords())
           throw IllegalStateException("Unsupported combination of selected words and test definition word list type")
    }

    fun getEffectiveSelectedWords(): WordSelection {
        return selectedWords ?: testDefinition.wordList.text!!
    }
    ...
    fun canGenerateWords(): Boolean = testDefinition.canGenerateWords()
